...
public class Principal {
	public static void main(String[] args) {
        ...
        Biblioteca.adicionarLivroNovo(new Livro(1l, "livro1", "autor1", "editora1", 1, "romance", 10, 4));
        Biblioteca.adicionarLivroNovo(new Livro(2l, "livro1", "autor2", "editora2", 1, "guerra", 10, 4));
        Biblioteca.adicionarLivroNovo(new Livro(3l, "livro3", "autor3", "editora3", 1, "romance", 10, 4));
        Biblioteca.adicionarLivroNovo(new Livro(4l, "livro4", "autor4", "editora4", 1, "guerra", 10, 4));
        Biblioteca.adicionarLivroNovo(new Livro(5l, "livro5", "autor5", "editora5", 1, "auto-ajuda", 10, 4));
        Biblioteca.adicionarLivroNovo(new Livro(6l, "livro6", "autor6", "editora6", 1, "romance", 10, 4));
        Biblioteca.adicionarLivroNovo(new Livro(7l, "livro7", "autor7", "editora7", 1, "auto-ajuda", 10, 4));
